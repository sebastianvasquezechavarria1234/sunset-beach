/**
 * Simplex 3D Noise - Adaptado para uso en CPU
 * Usado para generar posiciones iniciales de partículas y datos procedurales
 */
...
/**
 * Calcula ruido Simplex 3D
 * @param {number} xin - Coordenada X
 * @param {number} yin - Coordenada Y
 * @param {number} zin - Coordenada Z
...
/**
 * Ruido fractal (fbm) - suma de octavas de Simplex
 */
